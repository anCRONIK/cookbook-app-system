...
import net.ancronik.cookbook.backend.api.hateoas.SlicedModel;
import net.ancronik.cookbook.backend.api.hateoas.SlicedResourcesAssembler;
...
/**
 * Controller handling all operations for the {@link Recipe}.
 *
