...
@Tag(TestTypes.UNIT)
class RecipeBasicInfoModelAssemblerTest {
    ...
    void toModel_ModelWithIngredients_ValidDtoReturned() {
        ...
        assertEquals(
            "RecipeBasicInfoModel(id=1, title=title, shortDescription=short desc value, thumbnailUrl=null, dateCreated=2022-03-06T11:23, preparationTimeInMinutes=10, cookingTimeInMinutes=30, difficulty=1, category=entree, authorId=pero)",
            dto.toString()
        );
